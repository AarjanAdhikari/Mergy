...
const regex = /<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" title="Compliance monitors update as files are secured\.">[\s\S]*?<\/div>\s*<\/div>\s*<\/motion\.div>/;
...
if (regex.test(code)) {
  ...
  console.log("Success: Replaced checklist properly.");
} else {
  console.log("Error: Could not match the checklist area.");
}
